...
def api_timeline(prod_id):
    ...
    with get_db() as conn:
        ...
        # --- Locations ---
        locations = conn.execute("SELECT id, name, type, location_type FROM locations WHERE production_id=?", (prod_id,)).fetchall()
        for loc in locations:
            ...
            for s in schedules:
                ...
                phase_label = {'P': 'Prep', 'F': 'Filming', 'W': 'Wrap'}.get(status_val, status_val or 'Scheduled')
