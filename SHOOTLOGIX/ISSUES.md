...
## ~~[P1] Checklist tab broken — state.production undefined~~ FIXED 2026-04-04
- **Fixed in**: fix/2026-04-04-checklist-tab-broken
- **Resolution**: Replaced `state.production.id` with `state.prodId` in all checklist functions
