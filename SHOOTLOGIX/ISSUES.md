...
- **Fixed**: 2026-04-06 (branch: fix/2026-04-06-timeline-500-crash)
- **Symptoms**: `/api/productions/1/timeline` returned 500 with `sqlite3.OperationalError: no such column: site`
- **Root cause**: Query referenced `locations.site` and `location_schedules.prep/filming/wrap` which don't exist in the schema
- **Files involved**: `app.py` (line 7893)
