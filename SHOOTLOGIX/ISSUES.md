...
## [P1] [FIXED 2026-04-13] Pull-to-refresh broken on 6 tabs
- **Discovered**: 2026-04-13
- **Symptoms**: Swipe-to-refresh does nothing on Fleet, Crew, Today, Documents, Timeline, Checklist tabs
- **Root cause**: `_reloadCurrentTab()` in `app-monolith.js` was missing handlers for these 6 tab states
- **Fix**: Added reload handlers for all missing tabs, delegating to active sub-tabs for Fleet/Crew
