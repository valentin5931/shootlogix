...
## [P1] ~~Silent failures on destructive API operations~~ FIXED 2026-04-05
- **Fixed in**: fix/2026-04-05-missing-error-handling-destructive-ops
- **Details**: 10 DELETE/destructive calls across Transport, Fuel, Labour, Guards, Locations, and F&B modules lacked try/catch. Now all have error toasts.
