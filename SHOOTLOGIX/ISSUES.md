...
## [P1] Missing confirmation dialogs for destructive actions — FIXED 2026-04-06
- **Discovered**: 2026-04-06
- **Symptoms**: `deleteEventFromDay()` and `fnbCellClear()` deleted data without asking the user
- **Fix**: Added `showConfirm()` wrapper to both functions
- **Status**: FIXED in branch fix/2026-04-06-missing-delete-confirmations
