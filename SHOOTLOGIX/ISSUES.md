...
## [FIXED 2026-04-05] Timeline API crash — invalid column references
- **Discovered**: 2026-04-05
- **Fixed**: 2026-04-05 — Branch `fix/2026-04-05-timeline-api-crash-missing-site-column`
- **Resolution**: Fixed 3 SQL queries in `api_timeline` that referenced non-existent columns (`site`, `prep`/`filming`/`wrap`, `worker_id`)
