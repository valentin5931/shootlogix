...
- **Discovered**: 2026-03-22
- **Fixed**: 2026-04-06 — Added `_seed_picture_boat_entities()` and `_seed_security_boat_entities()` to `data_loader.py`. 38 picture boats and 5 security boats now seeded from fleet data.
