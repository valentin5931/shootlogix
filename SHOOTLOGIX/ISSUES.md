...
## ✅ FIXED 2026-04-08 — [P1] Stale state-variable names in `_findAssignment` and picture-boats refresh
- Fixed in branch `fix/2026-04-08-state-name-typos`. See CHANGELOG.md for details.
