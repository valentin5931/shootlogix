...
## [P1] ~~Picture Boats and Security Boats lists are empty~~ FIXED 2026-03-22
- **Discovered**: 2026-03-22
- **Fixed**: 2026-03-22 — Added `_seed_picture_boat_entities()` and `_seed_security_boat_entities()` in `data_loader.py` to copy 46 boats from `boats` table into `picture_boats` and `security_boats` tables
