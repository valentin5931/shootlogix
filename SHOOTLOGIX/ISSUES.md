...
- **Fixed in**: fix/2026-04-03-timeline-locations-crash
- **Root cause**: SQL query referenced non-existent columns (`locations.site`, `location_schedules.prep/filming/wrap`)
