...
## [P0] ~~Timeline API crash — invalid column references~~ FIXED 2026-04-06
- **Fixed in**: fix/2026-04-06-timeline-api-crash
- **Was**: `sqlite3.OperationalError: no such column: site` — Timeline endpoint referenced `site`, `prep`, `filming`, `wrap` columns that don't exist in the DB schema
