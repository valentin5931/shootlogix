...
## [FIXED] [P1] Boats and Picture Boats tabs show stale data after CRUD
- **Discovered**: 2026-03-22
- **Fixed**: 2026-04-05
- **Fix**: Added `_loadAndRenderBoats()` and `_loadAndRenderPictureBoats()` functions, wired into `setTab()` and `renderFleetUnified()`. Also fixed state variable mismatch in `_reloadCurrentTab()`.
