...
- **Discovered**: 2026-03-22
- **Fixed**: 2026-04-13 — Added "Import from Fleet" feature with API endpoints and UI modal. Users can now select boats from the main fleet and copy them into Picture Boats or Security Boats tabs.
