...
## ~~[P1] Missing confirmation dialogs on assignment deletion~~ FIXED 2026-04-05
- **Fixed in**: fix/2026-04-05-assignment-delete-confirm
- **Root cause**: 4 assignment removal functions (boats, picture boats, transport, security boats) lacked `showConfirm()` wrapper unlike labour/guards equivalents
