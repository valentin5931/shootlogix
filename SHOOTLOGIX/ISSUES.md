...
- **Discovered**: 2026-03-22
- **Fixed**: 2026-04-05 — Redirected all picture/security boat DB functions and SQL queries to use the `boats` table filtered by `category` instead of the empty `picture_boats`/`security_boats` tables.
