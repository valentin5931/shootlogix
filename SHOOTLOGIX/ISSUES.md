...
## [P0] ~~Timeline API crash — invalid column references~~ FIXED 2026-04-10
- **Fixed in**: fix/2026-04-10-timeline-api-crash
- **Was**: `sqlite3.OperationalError: no such column: site` on `/api/productions/<id>/timeline`
