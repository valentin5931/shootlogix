...
## ~~[P0] Mobile menu, activity panel, notifications, comments not functional~~ FIXED 2026-04-09
- **Fixed in**: fix/2026-04-09-missing-mobile-activity-notif-functions
- **Solution**: Ported all missing functions from dead `static/modules/` files into `app-monolith.js`
