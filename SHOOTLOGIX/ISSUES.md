...
## ~~[P1] Missing confirmation dialogs on assignment/event deletion~~ ✅ FIXED 2026-04-02
- **Fixed**: Added `showConfirm()` to `removeAssignmentById`, `pbRemoveAssignmentById`, `tbRemoveAssignmentById`, `sbRemoveAssignmentById`, and `deleteEventFromDay`
