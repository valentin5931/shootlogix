...
## [FIXED] [P0] Timeline tab broken — API crash + frontend registration race
- **Discovered**: 2026-04-06
- **Fixed**: 2026-04-06
- **Branch**: fix/2026-04-06-timeline-api-guard-column
- **Details**: timeline.js loaded before app-monolith.js so App.renderTimeline was never set; API crashed on wrong column names (worker_id, site, prep/filming/wrap)
